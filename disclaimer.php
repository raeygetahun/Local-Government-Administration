...
<html lang="en">
    ...
    <body>
        <header id="nav">
            <div>
              <a href="index.html">
              <img width="150" height="100" src="./pictures/logo.jpg">
                </a>
            </div>
            <div class="home">
        ...
        <div class="disclaimer">
            ...
            This website is made by r.getahun at jacobs-university, g.mengestu at jacobs-university, b.gudissa at jacobs-university and m.mostafa at jacobs-university 
        </div>
        <footer id="footer">
            ...
            <div class="inner-div"> <a href="#">Disclaimer</a></div>
            <!-- <div class="innder-div" id="link"><a href="#">IMPRINT PAGE</a></div> --> -->
