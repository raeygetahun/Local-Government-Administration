...
<body>
    <body>
        ...
        <div class="input-div">
            ...
            <form action="../php_scripts/payment.php" method="post">
            <?php include("connect.html") ?>
                
                <label for="amount">Amount of Payment: </label>
                <input type="number" class="input" step="0.01" name="amount"><br>
                
                <label for="date_of_payment">Date of Payment: </label>
                <input type="text" placeholder="YYYY-MM-DD" class="input" name="date_of_payment"><br>
