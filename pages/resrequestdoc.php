...
<body>
    <body>
        ...
        <div class="input-div">
            ...
            <form action="../php_scripts/request.php" method="post">
            <?php include("connect.html") ?>
              
                <label for="docid">Doc ID: </label>
                <input type="number" class="input" name="docid" id="docid">  <br>
                <button>
                    <a href="../php_scripts/documentpopup.php" target="popup" 
                        onclick="window.open('../php_scripts/documentpopup.php','popup','width=600,height=600'); return false;">
                        List of document IDs</a>
                 </button>

                
                <label for="residnetid">Resident ID: </label>
                <input type="number" class="input" name="residentid" id="residentid">  <br>
