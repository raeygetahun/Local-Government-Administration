...
<body>
    <body>
        ...
        <div class="input-div">
            <h4 class="message">Please Enter the Data for Birth Certeficate below</h4>
            <form action="../php_scripts/birthcertificate.php" method="post">
            <?php include("connect.html") ?>
                
                <label for="MotherName">Mother's Name</label>
                <input type="text" class="input" name="motherName" id="MotherName"><br>


                
                <label for="FatherName">Father's Name</label>
                <input type="text" class="input" name="fatherName"id="FatherName"><br>

                
                <label for="PlaceofBirth">Place of Birth: </label>
                <input type="text" class="input" name="placeofBirth" id="PlaceofBirth"><br>

                <label for="spousename">No of copies </label>
                <input type="number" name="No of copies"  class="input"><br>            
                
                <label for="comment">Comment: </label><br>
                <textarea name="comment" id="" cols="10" rows="2" class="input"></textarea><br> 
