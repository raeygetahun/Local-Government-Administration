...
<body>
    <body>
        ...
        <div class="input-div">
            <h4 class="message">Please Enter the Payment for Admin below</h4>
            <form action="../php_scripts/appointment.php" method="post">
            <?php include("connect.html") ?>

                <label for="appointment_date">Date of Appointment: </label>
                <input type="text" class="input" name="appointment_date" placeholder="YYYY-MM-DD"><br>
                
                
                <label for="appointment_time">Time of Appointment: </label>
                <input type="text" placeholder="HH:MM (24 Hour fomat)" class="input" name="appointment_time"><br>
